...
if (!process.env.EXPO_PUBLIC_SUPABASE_URL) throw new Error("Missing SUPABASE_URL");
if (!process.env.EXPO_PUBLIC_SUPABASE_ANON_KEY) throw new Error("Missing SUPABASE_ANON_KEY");
if (!process.env.EXPO_SUPABASE_SERVICE_ROLE_KEY)
